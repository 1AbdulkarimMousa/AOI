...
export function registerAdministration(Alpine) {
  Alpine.data("administrationPage", () => ({
    ...
    workspaceLinks: [
      { label: "Today", symbol: "T", href: `${pageUrl(import.meta.env.BASE_URL, "workspace.html")}?view=today&tab=briefing` },
      { label: "Relationships", symbol: "R", href: `${pageUrl(import.meta.env.BASE_URL, "workspace.html")}?view=relationships&tab=contacts` },
      { label: "Research", symbol: "R", href: `${pageUrl(import.meta.env.BASE_URL, "workspace.html")}?view=research&tab=collect` },
      { label: "End-of-Day Brief", symbol: "E", href: `${pageUrl(import.meta.env.BASE_URL, "workspace.html")}?view=eod` },
      { label: "Chat", symbol: "C", href: `${pageUrl(import.meta.env.BASE_URL, "workspace.html")}?view=chat` },
    ],
    ...
    guides: [
      ...
      { title: "Review onboarding", purpose: "Help new staff learn the workflow without monitoring behavior.", steps: ["Confirm the account is secure.", "Review workspace and data handling responsibilities.", "Walk through Today, Relationships, and Research.", "Check that the first EOD brief is complete."], section: "people", action: "Review people" },

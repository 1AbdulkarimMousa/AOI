...
<section class="inbox-workspace" aria-labelledby="inbox-heading">
  ...
  <div class="inbox-layout" :class="selectedInboxItem&&'has-selection'">
    ...
    <article x-show="selectedInboxItem" class="panel inbox-detail" aria-labelledby="inbox-item-heading" tabindex="-1">
      ...
      <div class="panel-heading"><div><span class="eyebrow" x-text="selectedInboxItem?.sourceType.replaceAll('_',' ')"></span><h2 id="inbox-item-heading" x-text="selectedInboxItem?.summary"></h2><p x-text="selectedInboxItem?.reason"></p></div><span class="status-badge" x-text="selectedInboxItem?.priority"></span></div>
